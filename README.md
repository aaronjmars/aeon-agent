...
> **This instance** tracks the [AEON token](https://basescan.org/token/0xbf8e8f0e8866a7052f948c16508644347c57aba3) on Base and the [aaronjmars/aeon](https://github.com/aaronjmars/aeon) repo. It writes articles, recaps pushes, monitors GitHub activity, builds features, and ships improvements back upstream — all autonomously.
